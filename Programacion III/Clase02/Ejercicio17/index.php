 ...
 */
 ...
 $autoUno = new Auto('Azul','Ford');
 $autoDos = new Auto('Rojo','Ford');

 $autoTres = new Auto('Verde',100,'Ford');
 $autoCuatro = new Auto('Verde',200,'Ford');

 $autoCinco = new Auto('Amarillo', 2000, 'Mazda', '25-04-2021');
 ...
 if($autoUno->Equals($autoDos)){
     echo 'Auto uno y auto dos son iguales. ';
    }else{
     echo 'Auto uno y auto dos son iguales. ';
 }

 if($autoUno->Equals($autoCinco)){
    echo 'Auto uno y auto cinco son iguales. ';
   }else{
    echo 'Auto uno y auto cinco son iguales. ';
}
