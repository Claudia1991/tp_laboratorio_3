<?php
require_once './Interfaces/iProductoService.php';
require_once './Modelos/Response.php';
require_once './Modelos/ResultadoInsercionProducto.php';
//require_once 'GeneradorId.php'; de momento no lo necesitamos, me da paja copiar y pegar
